...
def function_line():
	global CAR_CENTER, Obstacle, Speed, IsRed, x_point, Car_back
	while True:
				...
				num = int(num) # 선의 갯수
					...
					Speed = 0
       		                 	...
       		                 	if CAR_CENTER - 20 <= x_point and x_point <= CAR_CENTER + 20: # 300~340 사이
	           	                        print "straight "
	                                        ...
	                                        forward(Speed)
                                                ...
                                                print "right ", (x_point / 30) - 11
                                                turn_right((x_point / 30) - 11) 
                                                forward(Speed)
						...
						print "left ", (20-x_point/20)
	                               		...
	                               		turn_right((x_point / 17) - 20)
						print "right ", (x_point / 17) - 20
	                                	forward(Speed)
...
def function_YOLO():
	global Obstacle, Speed, Def_speed, IsRed, x_point, Car_back
	...
	while True:
		...
		isFire = False
	        while True:
				...
				if ((x_point - 200 < Center_human) and (Center_human < x_point + 200)):
	                            	print("human in line")
					if Speed != 0:
						for i in range(Speed,-1,-1):
							Speed = i
...
def function_VOICE():
	...
	while True:
		...
		while True:
				...
				print 'go'
				Voice = True
				os.system("mpg321 -o alsa 출발할게요.mp3")
    			elif data == '멈춰':
				print 'stop'
				Voice = False
				os.system("mpg321 -o alsa 멈출게요.mp3")
    			elif data == 'exit': # 연결 종료 신호
				Voice = True
				break
    		sock.close()
